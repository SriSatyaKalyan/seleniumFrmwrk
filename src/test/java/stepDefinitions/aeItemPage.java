...
//        } catch (TimeoutException e) {
//            Assert.fail("Product information section not found within 10 seconds");
//        } catch (Exception e) {
//            Assert.fail("Failed to verify product details. Expected: " + name + ", " + category + ", Rs. " + cost + ", " + availability + ", " + condition + ", " + brand + ". Error: " + e.getMessage());
//        }
    }
}
